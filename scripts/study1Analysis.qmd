...
df_out_files_study1 <- list.files("output/output_study1/ppvs/df_out/", pattern = "^df_out_", full.names = TRUE)
...
# see the problematic reps by condition
all_df_out_study1 %>%
  group_by(N, corr, TE, r) %>%
  summarise(
    n_div = unique(div),
...
# setwd("D:/projpred_vs_spikeslab")
ssvs_files_study1 <- list.files("output/output_study1/ssvs/ssvs_df_out/", pattern = "^ssvs_N", full.names = TRUE)
...
# setwd("D:/projpred_vs_spikeslab")
prj_pred_files_study1 <- list.files("output/output_study1/ppvs/prj_pred/", pattern = "^prj_pred_", full.names = TRUE)
...
# setwd("D:/projpred_vs_spikeslab")
ssvs_pred_files_study1 <- list.files("output/output_study1/ssvs/ssvs_pred_results/", pattern = "^ssvs_pred_results_N", full.names = TRUE)
...
```{r}
# Get all time files
time_files_study1 <- list.files("D:/projpred_vs_spikeslab/output/output_study1/ppvs/time_taken/", pattern = "^time_.*\\.RData$", full.names = TRUE)
...
```{r}
# Get all time files
time_files_ssvs_study1 <- list.files("D:/projpred_vs_spikeslab/output/output_study1/ssvs/time_taken/", pattern = "^time_.*\\.RData$", full.names = TRUE)
